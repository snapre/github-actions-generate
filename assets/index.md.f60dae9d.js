import{_ as n,c as s,o as a,a as t}from"./app.d6e6d9a8.js";const m='{"title":"Introduction","description":"","frontmatter":{},"headers":[{"level":2,"title":"Introduction","slug":"introduction"},{"level":2,"title":"Awesome configuration file","slug":"awesome-configuration-file"},{"level":3,"title":"Continuous integration","slug":"continuous-integration"},{"level":3,"title":"Document build","slug":"document-build"}],"relativePath":"index.md","lastUpdated":1651217085000}',p={},e=t(`<h2 id="introduction" tabindex="-1">Introduction <a class="header-anchor" href="#introduction" aria-hidden="true">#</a></h2><p>Practice GitHub Actions &amp; How to write a good actions <code>.yml</code> file.</p><h2 id="awesome-configuration-file" tabindex="-1">Awesome configuration file <a class="header-anchor" href="#awesome-configuration-file" aria-hidden="true">#</a></h2><h3 id="continuous-integration" tabindex="-1">Continuous integration <a class="header-anchor" href="#continuous-integration" aria-hidden="true">#</a></h3><div class="language-yml"><pre><code><span class="token key atrule">name</span><span class="token punctuation">:</span> CI
